...
const BestAiNoteTakingApp = () => {
  ...
  const taskManagerData = [
    ...
    },
    {
      id: "meetgeek",
      name: "MeetGeek",
      imageOne: "best-ai-meeting-managers-20250.webp",
      imageTwo: "best-ai-meeting-managers-20251.webp",
    ...
    <div className="container mx-auto">
      ...
      <div className=" w-90 my-10 lg:w-5/9 lg:mt-20 lg:mb-10 mx-auto">
        <div className="text-[16.95px] my-10 work-sans-400">
          {/* phần một */}
          <div>
            <img src="best-ai-note-taking-apps-2025.webp" alt="anh" className="w-full" />
            <h1 className="mt-10">
