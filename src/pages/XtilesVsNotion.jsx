    ...
    <div className="container mx-auto">
      ...
      <div className=" w-90 my-10 lg:w-5/9 lg:mt-20 lg:mb-10 mx-auto">
        <div className="text-[16.95px] my-10 work-sans-400">
          {/* phần một */}
          <div>
            <img src="best-ai-meeting-managers-202514.webp" alt="anh" />
            <h1 className="mt-10">
          ...
          <div>
            <div>
              ...
              <img src="best-ai-meeting-managers-202515.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202517.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202518.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202519.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202520.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202521.webp" alt="anh" />
              <p className="my-5">
              ...
              <img src="best-ai-meeting-managers-202522.webp" alt="anh" />
              <p className="my-5">
