  ...
  return (
    <div className="container mx-auto">
      <div className="w-6/7 flex flex-col mx-auto my-10 lg:my-20">
        <h1 className="text-center font-bold text-5xl lg:text-3xl leading-relaxed">Note-Taking Apps</h1>
        <hr className="w-3/4 mx-auto my-10 text-gray-200" />
        <div>
          <h5 className="font-bold text-3xl lg:text-xl my-5">What are you looking for?</h5>
